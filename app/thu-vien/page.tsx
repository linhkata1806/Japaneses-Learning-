...
export default function LibraryPage() {
  ...
  return <div className="min-h-screen bg-background">
    <header className="border-b border-border bg-white"><div className="mx-auto flex max-w-[1100px] justify-between px-5 py-4"><ManabiBrand compact /><Link href="/" className="text-sm font-semibold text-study-link">← Về luyện tập</Link></div></header>
